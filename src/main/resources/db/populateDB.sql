...
INSERT INTO meals (datetime, description, calories, user_id) VALUES
  ...
  ('2016-03-18 10:00:00', 'Перекус', 200, 100000),
  ('2016-03-18 12:00:00', 'Обед', 400, 100000),
  ('2016-03-18 16:00:00', 'Ланч', 400, 100000),
  ('2016-03-18 19:00:00', 'Ужин', 300, 100000),
  ('2016-03-19 8:00:00', 'Завтрак', 500, 100000),
  ('2016-03-19 10:00:00', 'Перекус', 300, 100000),
  ('2016-03-19 12:00:00', 'Обед', 500, 100000),
  ('2016-03-19 16:00:00', 'Ланч', 500, 100000),
  ('2016-03-19 19:00:00', 'Ужин', 400, 100000),
  ('2016-03-18 12:00:00', 'Завтрак админа', 500, 100001),
  ('2016-03-18 18:00:00', 'Обед админа', 800, 100001),
  ('2016-03-18 22:00:00', 'Ужин админа', 600, 100001),
